...
<style>
  ...
  <blade keyframes|%20load%20%7B%0D>0% {
    opacity: 0.08;
    filter: blur(5px);
    letter-spacing: 3px;
  }
    ...
    @foreach($ofertas as $oferta)
      <div class="card{{ $i }}">
        <div class="card z-depth-3">
          <div class="card-image">
            ...
            <img class="imgCard materialboxed"
              src="Imagenes/Productos/{{ $oferta->nom_fami }}/{{ $oferta->nom }}/{{ $oferta->id_produc }}/1.jpg">

            <a class="btn-floating halfway-fab waves-effect waves-light red modal-trigger" href="#modal{{ $p }}"><i
          ...
          <div class="card-content">
            ...
            <div class="CT" style="width: 200px; max-height: 800px;">
              <span class="card-title"
                style="text-overflow: ellipsis;   white-space: nowrap;  overflow: hidden;">{{ $oferta->titulo }}</span>
            </div>
      ...
      <div id="modal{{ $p }}" class="modal">
        ...
        <div class="modal-footer">
          ...
          <a href="{{ url("carrito/{$oferta->id_produc}") }}"
            class="btn waves-effect waves-light btnAgregarCarrito"
            onclick="swal({icon: 'success', text: '¡Agregado a carrito!', });"><i
              class="large material-icons">add_shopping_cart</i>Agregar </a>
          <a href="{{ route('producto',['num_produc' => $oferta->id_produc]) }}"
            class="btn waves-effect waves-light btnComprar" style="width: 25%;">Especificaciones<i
