...
<div class="row">
    <div class="col s12 m6">
      <div class="card">
        ...
        <div class="card-action">
          <a onclick="window.location='{{ url('/admin/gestionarproducto') }}'">IR A GESTIOR DE PRODUCTOS</a>
        </div>
      </div>
 </div>
 ...
 <div class="col s12 m6">
    <div class="card">
      ...
      <div class="card-action">
        <a onclick="window.location='{{ url('/admin/gestionpromocion') }}'">IR A GESTOR DE OFERTAS</a>
      </div>
    </div>
</div>
...
<div class="row">
    <div class="col s12 m6">
      <div class="card">
        ...
        <div class="card-action">
          <a onclick="window.location='{{ url('/admin/gestionproveedores') }}'">IR A GESTOR DE PROVEEDORES</a>
        </div>
      </div>
 </div>
