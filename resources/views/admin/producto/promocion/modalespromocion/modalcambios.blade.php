        ...
        <div class="modal-body">
            <div class="contenido">
                 <div class="row">
                    ...
                    <form class="col s12" action="{{ url("/admin/cambiopromocion/{$resultados->id_oferta}")}}" method="post" 
                        ...
                        <div class="input-field col s12">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <select id="id_produc" name="id_produc"  required disabled>
                                        <option value="{{ $resultados->id_produc }}" selected="true" disabled="disabled">{{ $resultados->titulo}}</option>
                                     </select>
                            ...
                            <div class="row">
                                <div class="input-field col s6">
                                    <input type="date" data-date="" data-date-format="YYYY MMMM DD"  required value="{{ $resultados->fech_ini }}"
                                        id="fech_ini" name="fech_ini" readonly>
                                    <label for="fech_ini">FECHA INICIO:</label>
                                </div>
                                <div class="input-field col s6">
                                    <input type="date" data-date="" data-date-format="YYYY MMMM DD"  required value="{{ $resultados->fech_ter }}"
                                        id="fech_ter" name="fech_ter">
                            ...
                            <div class="row">
                                <div class="input-field col s6">
                                    <input type="time" id="hora_ini" name="hora_ini"  required  value="{{ $resultados->hora_ini}}" readonly>
                                    <label for="hora_ini">HORA DE INICIO:</label>
                                </div>
                                <div class="input-field col s6">
                                    <input type="time" id="hora_ter" name="hora_ter" required  value="{{ $resultados->hora_ter}}">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input type="number" id="desc" name="desc" min="1" max="100" required value="{{ $resultados->desc}}">
